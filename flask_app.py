...
def show_main_menu(context: FSMContext, resp: dict | Response, text: str | typing.Sequence[str] | None = None,
    ...
    answer_options = ['Приступаем к работе. Выбирайте чем займёмся:', 'Чем хотите заняться? Выбирайте:', 'Чем займёмся на этот раз? Выбирайте:', 'Вы уже в нескольких шагах от здорового образа жизни! Чем сегодня займёмся? Выбирайте:']
    resp.response = ResponseField(
