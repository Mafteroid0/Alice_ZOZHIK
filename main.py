    ...
    class Sport(StatesGroup):
        ...
        class Wrap(StatesGroup):
            ...
            class WarmUp(StatesGroup):
                ...
                qw = State(_help_message='Вы можете перейти к выполнению упражнения командой "Поехали". Также можно вернуться обратно к выбору тренировки командой "Вернуться к основному списку"')
                start = State(_help_message='Вы можете перейти к выполнению упражнения командой "Поехали". Также можно вернуться обратно к выбору тренировки командой "Вернуться к основному списку"')
