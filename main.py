    ...
    if fsm.get_state(user_id) is None and (command == 'что ты умеешь'):
        ...
        if fsm.get_state(user_id) == MainGroup.SportBranch.state_home:
            ...
            if fsm.get_state(user_id) == MainGroup.SportBranch.Dream.state_1:
                ...
                answer_options = [
                    f'Чтобы после сна чувствовать себя полным энергией, Вам следует лечь спать в {go_sleep_times[0]} '
                    f'или в {go_sleep_times[1]}😴. Не забудьте завести будильник!',

                    f'Ложитесь спать в {go_sleep_times[0]} или в {go_sleep_times[1]}, '
            ...
            if fsm.get_state(user_id) == MainGroup.SportBranch.Water.state_1:
                ...
                if (fsm.get_state(user_id) == MainGroup.SportBranch.Water.end and (
