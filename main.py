    ...
    resp.update({
        'response': {
            ...
            'card': {
                'type': 'ItemsList',
                'header': {
                    'text': 'Приступаем к выполнению сосанию у Фарела кардиотренировки'
                },
                'items': [
                    {"title": 'Я готов', "button": {"text": 'Я готов'},
                     "image_id": '997614/72ab6692a3db3f4e3056'},
...
def any_from(l: list[str], *, in_: str):
    return any((i in l for i in in_))


def start_session(user_id: str, resp: dict) -> dict:
                ...
                if 'друг' in command or 'не' in command:
                    ...
                    resp.update({
                        'response': {
                            ...
                            'card': {
                                'type': 'BigImage',
                                "image_id": '1540737/f66176e3752b6f738011',
                                "title": 'Упражнение 1',
                                "description": 'Отжимания'
                            }
                            ,
                ...
                if 'подробн' in command or 'объяс' in command:
                    ...
                    resp.update({
                        'response': {
                            ...
                            'card': {
                                'type': 'BigImage',
                                "image_id": '997614/dad71a070163093fbc4f',
                                "title": 'Упражнение 2',
