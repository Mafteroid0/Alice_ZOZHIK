        ...
        try:
            ...
            resp.response = ResponseField(
                text='Извините, не поняла вас. Пожалуйста, повторите: во сколько вы планируете проснуться? Если '
                     'ошибка повторится, попробуйте перефразировать время пробуждения. Лучше всего будет сказать его по шаблону 12:34',
                tts='Извините, не поняла вас. Пожалуйста, повторите: во сколько вы планируете проснуться? Если '
                     'ошибка повторится, попробуйте перефразировать время пробуждения. Лучше всего будет сказать его по шаблону двенадцать тридцать четыре'
            )
        else:
            try:
